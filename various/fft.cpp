...
std::complex<float> *v =
	 (std::complex<float> *)alloca (fft_size * sizeof (std::complex<float>));

	memcpy (v, vector, fft_size * sizeof (std::complex<float>));
	memcpy (vector, &v [fft_size / 2],
	                   fft_size / 2 * sizeof (std::complex<float>));
	memcpy (&vector [fft_size / 2], v,
	                   fft_size / 2 * sizeof (std::complex<float>));
}
